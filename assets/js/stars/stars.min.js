!(function(t) {
  t.fn.stars = function(e) {
    for (
      ...
      var n = t("<i>")
        .addClass("fa")
        .addClass(s.emptyIcon)
        .addClass(s.starClass);
      ...
      (r
        .on("mouseover", function() {
          var e = t(this).index() + 1,
            l = r.slice(0, e);
          events.removeFilledStars(r, s),
            events.fillStars(l, s),
            s.text && a.find(".rating-text").html(t(this).data("rating-text"));
        })
        .on("mouseout", function() {
          events.removeFilledStars(r, s),
            events.fillStars(r.filter(".selected"), s),
            s.text && a.find(".rating-text").html("");
        })
        .on("click", function() {
          var e = t(this).index();
          (s.value = e + 1),
